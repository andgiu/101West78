...
$page = "home";
$lang = "en-us";
$SITETitle = '101 West 78 | Upper West Side Condominiums for Sale';
$SITEDescription = '101 West 78 has 2- to 5-bedroom Upper West Side park-view condominiums and one extraordinary rooftop penthouse. Interiors by Stephen Sills. ';
$SITEKeywords = '';  
$SITEUrl = full_url( $_SERVER );
$SITEShareImage = $SITEUrl.'src/assets/share.jpg';
$preloadID = 0;
$br = $smartphone ? ' ' : '<br>';
if(isset($_SESSION["home-load"])) {
    
    $noloadClass="noload ";

} else {

    $_SESSION["home-load"] = 1;
    $noloadClass = "";
}
?>

<!doctype html>
<html lang="<?=$lang;?>" class="<?php echo $noloadClass;?> <?php echo $mobile ? 'mobile' : ''; ?> <?php echo $smartphone ? 'smartphone' : ''; ?> <?php echo $desktop ? 'desktop' : ''; ?>">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <!-- SLIDE -->
            <?php $arrowScroll = "#residences"; ?>
            <?php $arrayImages = array('building-detail.jpg'); ?>
            ...
            <?php $arrowScroll = "#neighborhood"; ?>
            <?php $arrayImages = array('amenities3.jpg'); ?>
            <?php include 'sections/section-carousel.php';?>
            ...
            <?php include 'sections/section-carousel.php';?>
            <?php include 'sections/section-contact-us.php'; ?>
