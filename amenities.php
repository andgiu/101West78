...
$lang = "en-us";
$SITETitle = '101 West 78 ‒ Amenities | Luxury Upper West Side Condominiums';
$SITEDescription = 'Featuring a limited number of boutique luxury Upper West Side condominiums, 101 West 78 provides both privacy and a high level of service.';
$SITEKeywords = '';
...
<html lang="<?=$lang;?>" class="noload <?php echo $mobile ? 'mobile' : ''; ?> <?php echo $smartphone ? 'smartphone' : ''; ?> <?php echo $desktop ? 'desktop' : ''; ?>">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php include 'sections/section-paragraph-amenities-internal.php';?>

            <!-- SLIDE -->
            <?php $arrowScroll = "#preload-2"; $scrollAmenities = true; ?>
