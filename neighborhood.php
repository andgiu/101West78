...
$lang = "en-us";
$SITETitle = '101 West 78 – UWS | New Upper West Side Condominiums';
$SITEDescription = 'These Upper West Side Condominiums are situated in one of NYC’s most desirable locations, steps from Central Park and across from the American Museum of Natural History.';
$SITEKeywords = '';  
...
<html lang="<?=$lang;?>" class="noload <?php echo $mobile ? 'mobile' : ''; ?> <?php echo $smartphone ? 'smartphone' : ''; ?> <?php echo $desktop ? 'desktop' : ''; ?>">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php include 'sections/section-paragraph-neighborhood-internal.php';?>
