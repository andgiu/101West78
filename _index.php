...
<!doctype html>
<html lang="<?=$lang;?>" class="<?php echo $mobile ? 'mobile' : ''; ?> <?php echo $smartphone ? 'smartphone' : ''; ?> <?php echo $desktop ? 'desktop' : ''; ?>">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <!-- HOME -->
            <?php include 'sections/section-home.php'; ?>
            <?php include 'sections/section-paragraph-home.php';?>
            
            <?php $arrayImages = array('home2.jpg'); ?>
            <?php include 'sections/section-carousel.php'; ?>
            <?php include 'sections/section-paragraph-building.php';?>
            
            <!-- SLIDE -->
            <?php $arrayImages = array('building.jpg'); ?>
            <?php include 'sections/section-carousel-fs.php'; ?>
            <?php include 'sections/section-paragraph-architects.php';?>
            
            <!-- HISTORY -->
            <?php include 'sections/section-paragraph-history.php';?>
            
            <?php include 'sections/section-slide.php';?>
            
            
            <!--
            <?php $arrayImages = array('history-01.jpg'); ?>
            <?php include 'sections/section-carousel.php';?>
            -->
            
            
            <!-- DESIGN -->
            <?php include 'sections/section-paragraph-design.php';?>
            
            <?php $arrayImages = array('history-01.jpg'); ?>
            <?php include 'sections/section-carousel.php';?>
            
            <?php include 'sections/section-paragraph-residences.php';?>
            ...
            <?php include 'sections/section-carousel.php';?>
            <?php include 'sections/section-gallery-double.php'; ?>
            
            <!--
            <?php $arrayImages = array('building2.jpg'); ?>
            <?php include 'sections/section-carousel.php';?>
            -->
            ...
            <!-- AMENITIES -->
            <?php include 'sections/section-paragraph-amenities.php';?>
            <?php $arrayImages = array('lobby.jpg'); ?>
            <?php include 'sections/section-carousel.php';?>
            
            <!--
            <?php include 'sections/section-quote-amenities.php';?>
            -->
            
            
            
            <!-- NEIGHBORHOOD -->
            <?php include 'sections/section-paragraph-neighborhood_title.php';?>
            
            <?php $arrayImages = array('neighborhood.jpg'); ?>
            <?php include 'sections/section-carousel.php';?>
            
            <!-- MEDIA -->
            <?php include 'sections/section-media1.php'; ?>
            <?php include 'sections/section-media2.php'; ?>
            <?php include 'sections/section-media3.php'; ?>
            <?php include 'sections/section-media4.php'; ?>
            
            <?php include 'sections/section-map.php'; ?>
            ...
            <!-- TEAM -->
            <?php include 'sections/section-team.php'; ?>
            <?php include 'sections/section-team-image.php'; ?>
            
            <!-- CONTACTS -->
            <?php include 'sections/section-contacts.php'; ?>
            
            <!-- PRESS and BLOG -->
            <?php include 'sections/section-press.php'; ?>
            <?php include 'sections/section-blog.php'; ?>
